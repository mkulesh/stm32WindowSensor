 ...
 * <p>
 * In its present form it has one significant limitation. It uses the {@link SVG#renderToPicture()} method. That means
 * that SVG documents that use {@code <mask>} elements will not display correctly.
 * 
